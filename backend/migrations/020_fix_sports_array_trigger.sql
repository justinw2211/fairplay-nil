-- Migration 020: Fix sports array handling in profile trigger
-- Created: 2025-07-30
-- Description: Fix the handle_new_user function to properly handle sports array from metadata
...
-- Update the function to handle sports array correctly
