...
import DealsTable from '../components/DealsTable'; // We will create this
import SummaryCards from '../components/SummaryCards'; // We will create this
  ...
  return (
    <Box p={8} maxW="1200px" mx="auto">
      <Flex justify="space-between" align="center" mb={6}>
        <Heading as="h1" size="xl">Your Dashboard</Heading>
      ...
      <Box mt={10}>
        {deals.length === 0 ? (
          <Flex direction="column" align="center" justify="center" bg="gray.50" p={10} borderRadius="lg">
            ...
            <Button mt={4} onClick={() => navigate('/fmvcalculator')}>Calculate Your First FMV</Button>
          </Flex>
        ) : (
